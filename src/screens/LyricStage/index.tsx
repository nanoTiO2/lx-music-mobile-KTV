...
const MODE_ORDER: StageMode[] = ['full', 'threeLine', 'teleprompter']
const MIRROR_ORDER: MirrorMode[] = ['none', 'horizontal', 'vertical']
const ROTATE_ORDER = ['auto', 'landscape', 'portrait'] as const
type RotateMode = typeof ROTATE_ORDER[number]
const ROTATE_LABELS: Record<RotateMode, string> = {
  auto: '自动转向',
  landscape: '锁横屏',
  portrait: '锁竖屏',
}
const MARQUEE_THEME_ORDER: ColorTheme[] = ['emerald', 'amber', 'ice', 'rose', 'mono']
