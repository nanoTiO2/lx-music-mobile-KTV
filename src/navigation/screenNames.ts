...
export const LYRIC_STAGE_SCREEN = 'lxm.LyricStageScreen'
export const PROMPT_CONTROL_SCREEN = 'lxm.PromptControlScreen'
export const PROMPT_STAGE_SCREEN = 'lxm.PromptStageScreen'
export const PROMPT_RECEIVER_SCREEN = 'lxm.PromptReceiverScreen'
