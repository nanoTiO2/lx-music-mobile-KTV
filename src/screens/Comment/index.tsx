    ...
    <PageContent>
      {
        musicInfo == null
          ? null
          : <>
            <Header musicInfo={musicInfo} dimmed={musicInfo.source == 'local'} />
            {
              musicInfo.source == 'local'
                ? (
                <View style={styles.unsupportedPage}>
                  <View style={styles.unsupportedWrap}>
                    <View style={styles.unsupportedCard}>
                      <Text size={15} color="rgba(255,255,255,0.72)">本地歌曲评论</Text>
                      <Text size={13} color="rgba(255,255,255,0.48)">{t('comment_not support')}</Text>
                    </View>
                  </View>
                </View>
                  )
